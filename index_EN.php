...
<body>
    ...
    <main>
        ...
        <section class="contenedor sobre-nosotros mb-4">
            <h2 class="titulo">About us</h2><br>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h3 class="card-title text-center contenido-textos" style="color: #83C976; font-weight: bold;"><span class="circulo"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevrons-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    </svg></span> What can you find on our blog</h3>
                                <p class="card-text tam-texto" style="text-align: justify;">In this blog you can find opinions about the best restaurants in Manzanillo, as well as tourist places to go and have fun with friends and family.</p>
                            </div>
                        </div>
                    </div>
                </div>              
        ...
        <section class="manzanilloo mb-4">
            ...
            <p class="tam-texto-man contenido-textos">Manzanillo is an active port and a tourist destination, located on the Pacific Ocean coast, with two bays; Manzanillo and Santiago.</p>
        ...
        <section class="opciones">
            <div class="contenedor">
                <h2 class="titulo">Categories</h2><br>
                <div class="galeria-opc">
                    <a href="/paginas_EN/turismo.php" style="text-decoration: none; color: #000000;">
                    ...
                    <a href="/paginas_EN/gastronomia.php" style="text-decoration: none; color: #000000;">
                    <div class="imagen-opc">
