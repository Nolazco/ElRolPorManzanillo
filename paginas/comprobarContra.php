...
if($id == null)
{
    echo '<script language="javascript">alert("Datos incorrectos");window.location.href="recuperarContraseña.php"</script>';
        ...
        <div class="formulario mt-2 mb-2" style="background: #F1EAC9">
            ...
            <div style="padding: 30px;">
                ...
                <form action="cambioContra.php" method="post">
                  ...
                  <center>
                    <input class="boton1" type="submit" value="Cambiar">
                  </center>
                </form>
            </div>
        </div>
