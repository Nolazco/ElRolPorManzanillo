                ...
                <div class="col-md-8" style="text-align: justify;">
                    <div class="rounded-3 contenedorPost">
                        <?php foreach($publicaciones as $publicacion): ?>
                            <h1 class="text-center" style="color: #5D8233;"><?= htmlspecialchars($publicacion['title']) ?></h1>
                            ...
                            <div style="clear: both;overflow: hidden;">
                                ...
                                <p style="word-break: break-all; word-spacing: normal; white-space: pre-wrap;"><?= htmlspecialchars($publicacion['inf_blog']) ?></p>
                                <h3>
                            ...
                            <?php foreach($publicaciones2 as $publicacion2): ?>
                                <div class="card mt-3 p-1 text-dark bg-opacity-25" style="width: 18rem; text-align: left; background: #EBE5DC;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <center><a class="btn btn-outline-dark" href="gastronomiaPost.php?id=<?php echo $publicacion2['id_publicacion'];?>" role="button"><i class="bi bi-info-circle"></i> Ver más...</a></center>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </center>
