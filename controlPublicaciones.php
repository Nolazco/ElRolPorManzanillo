            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <p>Administracion de publicaciones.</p><br>
                        <p>Opt1 = Lugar turistico.</p><br>
                        <p>Opt2 = Restaurante.</p><br>
                        ...
                        <?php foreach($publicaciones as $publicacion): ?>
                            <tr>
                              ...
                              <td>
                                <a href="deletePost.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a>
                              </td>
                            </tr>
                        <?php endforeach ?>
                           </tbody>
