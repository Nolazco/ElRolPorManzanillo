...
<body>
    ...
    <main>
        ...
        <section class="contenedor sobre-nosotros mb-4">
            <h2 class="titulo">À propos de nous</h2><br>
        ...
        <section class="opciones">
            <div class="contenedor">
                <h2 class="titulo">Catégories</h2><br>
                <div class="galeria-opc">
                    <a href="/paginas_FR/turismo.php" style="text-decoration: none; color: #000000;">
                    ...
                    <a href="/paginas_FR/gastronomia.php" style="text-decoration: none; color: #000000;">
                    <div class="imagen-opc">
