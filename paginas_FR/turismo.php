<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones_fr WHERE categoria = 'opt1'";
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <center><a class="btn btn-outline-dark" href="turismoPost.php?id=<?php echo $publicacion['id_publicacion'];?>" role="button"><i class="bi bi-info-circle"></i> Voir plus...</a></center>
                                </div>
                            </div>
                        </div>
                    </div>
