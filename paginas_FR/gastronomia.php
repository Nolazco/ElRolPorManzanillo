<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones_fr WHERE categoria = 'opt2'";
          ...
          <div class="card mb-3 p-1 text-dark bg-opacity-25" style="background: #EBE5DC;">
            ...
            <div class="col-md-6">
              <div class="card-body">
                ...
                <p class="card-text">Auteur: <?= $publicacion['autor_blog'] ?></p>
                <p class="card-text"><?= $publicacion['resumen_blog'] ?></p>
                <p class="card-text"><small><?= $publicacion['date_created'] ?></small></p>
                <center><a class="btn btn-outline-dark" href="gastronomiaPost.php?id=<?php echo $publicacion['id_publicacion'];?>" role="button"><i class="bi bi-info-circle"></i> Voir plus...</a></center>
              </div>
            </div>
            </div>
          </div>
