...
if($id == null)
{
    echo '<script language="javascript">alert("Incorrect data");window.location.href="recuperarContraseña.php"</script>';

}else{
echo "Your data is correct change your password";
}
        ...
        <div class="formulario mt-2 mb-2" style="background: #F1EAC9">
            ...
            <div style="padding: 30px;">
                ...
                <form action="cambioContra.php" method="post">
                  ...
                  <div class="mb-3">
                    <label class="form-label fw-bold">Verify password <i class="bi bi-key-fill"></i>:</label>
                    <input type="password" class="form-control" name="passw_user1" required>
                  </div>

                  <center>
                    <input class="boton1" type="submit" value="Change">
                  </center>
                </form>
            </div>
        </div>
