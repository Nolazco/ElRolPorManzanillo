<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones_en WHERE categoria = 'opt2'";
          ...
          <div class="card mb-3 p-1 text-dark bg-opacity-25" style="background: #EBE5DC;">
            ...
            <div class="col-md-6">
              <div class="card-body">
                ...
                <center><a class="btn btn-outline-dark" href="gastronomiaPost.php?id=<?php echo $publicacion['id_publicacion'];?>" role="button"><i class="bi bi-info-circle"></i> See more...</a></center>
              </div>
            </div>
            </div>
          </div>
