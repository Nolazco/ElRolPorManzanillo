<?php 
    ...
    $obtencion2 = "SELECT * FROM publicaciones_en WHERE id_publicacion != '$id' and categoria = 'opt1' LIMIT 5";
        ...
        <main class="container">
            <div class="row g-0">
                ...
                <div class="col-md-4">
                    <div>
                        <center>
                            <h2 class="text-center">More Tourism</h2>
                            <?php foreach($publicaciones2 as $publicacion2): ?>
                                <div class="card mt-3 p-1 text-dark bg-opacity-25" style="width: 18rem; text-align: left; background: #EBE5DC;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <center><a class="btn btn-outline-dark" href="turismoPost.php?id=<?php echo $publicacion2['id_publicacion'];?>" role="button"><i class="bi bi-info-circle"></i> See more...</a></center>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </center>
