...
<body style="background: url(../src/amarillo.jpeg);">
  ...
  <?php
    ...
    $obtencion = "SELECT * FROM publicaciones WHERE categoria = 'opt2'";
  ...
  <?php foreach($publicaciones as $publicacion): ?>
        <div class="container">
          <div class="card mb-3 bg-warning p-1 text-dark bg-opacity-10">
            <div class="row g-0">
              <div class="col-md-4">
