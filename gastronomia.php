...
<body style="background: url(src/restaurante.jpg); background-size: cover;">
	<div>
    ...
    <?php
      ...
      $obtencion = "SELECT title, categoria, inf_blog, img_blog, date_created, resumen_blog FROM publicaciones WHERE  id_publicacion = '$i' AND categoria = 'opt2'";
