...
if (!$mysqli->query("INSERT INTO `publicaciones` (`title`,`categoria`,`inf_blog`,`img_blog`,`date_created`, `resumen_blog`,`autor_blog`,`rating`) VALUES ('$titulo', '$categoria','$inf','$name_img','$fecha', '$res', '$nombre','$rating')")) {
