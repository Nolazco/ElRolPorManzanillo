...
<body class="container" style="background: #F1EAC9">
    <div class="fs-1 container" style="text-align: left; text-decoration: none;"><a href="controlPublicaciones_EN.php"><i class="bi bi-wrench-adjustable-circle"></i></i><i class="bi bi-arrow-left"></i></a></div>
    <div style="padding: 30px;">
    <center>
        <div class="mb-3 mt-2" style="width: 90%;">
            <article>
                <?php foreach($publicaciones as $publicacion): ?>
                    <form action="setEdit_EN.php?id=<?php echo $publicacion['id_publicacion'];?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="controlPublicaciones_EN.php" class="btn btn-secondary btn-icon-split">
