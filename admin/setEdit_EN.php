...
if (!$mysqli->query("UPDATE publicaciones_en SET title = '$titulo', categoria = '$categoria', inf_blog = '$inf', img_blog = '$name_img', date_created = '$fecha', resumen_blog = '$res', autor_blog = '$nombre' WHERE id_publicacion = '$id'")) {
