<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones";
...
<head>
    ...
    <title>Control de publicaciones en español</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <p>Administracion de publicaciones en español.</p><br>
                        <a href="newblog.php" class="btn btn-primary btn-icon-split">
                        ...
                        <?php foreach($publicaciones as $publicacion): ?>
                            <tr>
                              ...
                              <td>
                                <a href="deletePost.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-danger btn-circle"><i class="bi bi-trash"></i></a>
                                <a href="vistaPrevia.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-primary btn-circle"><i class="bi bi-eye"></i></a>
                                <a href="editBlog.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-warning btn-circle"><i class="bi bi-pencil"></i></a>
                              </td>
                            </tr>
                        <?php endforeach ?>
                           </tbody>
