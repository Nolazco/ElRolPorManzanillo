                ...
                <div class="col-md-4">
                    <div style="border: 5px solid #F2D2A2;">
                        <center>
                            ...
                            <a href="editBlog_AL.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-warning btn-icon-split">
                                <span class="icon text-white-50">
                                    <i class="bi bi-pencil"></i>
                                </span>
                                <span class="text">Editar</span>
                            </a><br><br>
                            <a href="deletePost_AL.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-danger btn-icon-split">
                                <span class="icon text-white-50">
