<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones_al";
...
<head>
    ...
    <title>Control de publicaciones en alemán</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <a href="newblog_AL.php" class="btn btn-primary btn-icon-split">
                        ...
                        <?php foreach($publicaciones as $publicacion): ?>
                            <tr>
                              ...
                              <td>
                                <a href="deletePost_AL.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-danger btn-circle"><i class="bi bi-trash"></i></a>
                                <a href="vistaPrevia_AL.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-primary btn-circle"><i class="bi bi-eye"></i></a>
                                <a href="editBlog_AL.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-warning btn-circle"><i class="bi bi-pencil"></i></a>
                              </td>
                            </tr>
                        <?php endforeach ?>
                           </tbody>
