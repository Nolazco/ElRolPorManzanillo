<?php 
    ...
    if(!empty($_POST)){
    	...
    	$borrar = mysqli_query($mysqli, "DELETE FROM datos_user WHERE id_user = '$idUser'");
    ...
    $obtencion = "SELECT * FROM datos_user WHERE id_user = '$id'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <p>Administracion de usuarios.</p><br>
                        <p>Borrar usuarios.</p><br> 
						<center>
	                        <?php foreach($usuarios as $usuario): ?>
	                        	<h5>ID del usuario: <?= $usuario['id_user'] ?></h5>
	                        	<h5>Nombre del usuario: <?= $usuario['nameR_user'] ?></h5>
	                        	<h5>Correo del usuario: <?= $usuario['correo_user'] ?></h5>
	                        	<h5>Telefono del usuario: <?= $usuario['telefono_user'] ?></h5>
	                        	<h5>Tipo de usuario: <?php if(($usuario['tipo_user']) == 1){echo "Admin";}else{echo "Lector";} ?></h5>	               
	                        <?php endforeach ?>
							
                            <form method="post" action="">
                            	<a href="controlUsuarios.php" class="btn btn-secondary btn-icon-split">
                            	...
                            	<input type="hidden" name="idUser" value="<?php echo $usuario['id_user'];?>">
