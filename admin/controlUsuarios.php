...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/admin/controlPanel.php">
                ...
                <div class="container-fluid">
                    ...
                    <?php foreach($usuarios as $usuario): ?>
                            <tr>
                              ...
                              <td>
                                  <?php if ($nombre != $usuario['nameR_user']){ ?>
                                    <a href="deleteUser.php?id=<?php echo $usuario['id_user'];?>" class="btn btn-danger btn-circle"><i class="bi bi-trash"></i></i></a>
                                  <?php }?>
                              </td>
                            </tr>
                    <?php endforeach ?>
