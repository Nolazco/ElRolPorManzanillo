...
if($categoria != 'opt1' && $categoria != 'opt2'){
    ...
    header("Location: editBlog_FR.php");
}else{
...
if (!$mysqli->query("UPDATE publicaciones_fr SET title = '$titulo', categoria = '$categoria', inf_blog = '$inf', img_blog = '$name_img', date_created = '$fecha', resumen_blog = '$res', autor_blog = '$nombre', rating = '$rating' WHERE id_publicacion = '$id'")) {
