...
if (!$mysqli->query("INSERT INTO `publicaciones_en` (`title`,`categoria`,`inf_blog`,`img_blog`,`date_created`, `resumen_blog`,`autor_blog`) VALUES ('$titulo', '$categoria','$inf','$name_img','$fecha', '$res', '$nombre')")) {
