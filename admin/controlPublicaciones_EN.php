<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones_en";
...
<head>
    ...
    <title>Control de publicaciones en inglés</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <p>Administracion de publicaciones en inglés.</p><br>
                        <a href="newblog_EN.php" class="btn btn-primary btn-icon-split">
                        ...
                        <?php foreach($publicaciones as $publicacion): ?>
                            <tr>
                              ...
                              <td>
                                <a href="deletePost_EN.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-danger btn-circle"><i class="bi bi-trash"></i></a>
                                <a href="vistaPrevia_EN.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-primary btn-circle"><i class="bi bi-eye"></i></a>
                                <a href="editBlog_EN.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-warning btn-circle"><i class="bi bi-pencil"></i></a>
                              </td>
                            </tr>
                        <?php endforeach ?>
                           </tbody>
