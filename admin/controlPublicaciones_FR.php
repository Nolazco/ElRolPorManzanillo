<?php 
    ...
    $obtencion = "SELECT * FROM publicaciones_fr";
...
<head>
    ...
    <title>Control de publicaciones en francés</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <p>Administracion de publicaciones en francés.</p><br>
                        <a href="newblog_FR.php" class="btn btn-primary btn-icon-split">
                        ...
                        <?php foreach($publicaciones as $publicacion): ?>
                            <tr>
                              <th scope="row"><?= $publicacion['id_publicacion'] ?></th>
                              <td><img src='/archivos/<?= $publicacion['img_blog'] ?>' class="img-fluid rounded-start" style="width: 5pc;"></td>
                              <td><?= $publicacion['title'] ?></td>
                              <td><?php if (($publicacion['categoria']) == 'opt1'){echo "Turismo";}else{echo "Gastronomia";} ?></td>
                              <td><?= $publicacion['autor_blog'] ?></td>
                              <td><?= $publicacion['date_created'] ?></td>
                              <td>
                                <a href="deletePost_FR.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-danger btn-circle"><i class="bi bi-trash"></i></a>
                                <a href="vistaPrevia_FR.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-primary btn-circle"><i class="bi bi-eye"></i></a>
                                <a href="editBlog_FR.php?id=<?php echo $publicacion['id_publicacion'];?>" class="btn btn-warning btn-circle"><i class="bi bi-pencil"></i></a>
                              </td>
                            </tr>
                        <?php endforeach ?>
                           </tbody>
