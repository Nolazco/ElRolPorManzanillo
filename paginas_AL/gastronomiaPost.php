<?php 
    ...
    $obtencion2 = "SELECT * FROM publicaciones_al WHERE id_publicacion != '$id' and categoria = 'opt2' LIMIT 5";
                    ...
                    <div class="mt-3 rounded-3 contenedorComentarios">
                        ...
                        <?php if(isset($_SESSION['nameR_user'])): ?>
                            <form class="mt-3" action="procesarComentario.php?id=<?php echo $id_pub; ?>" method="POST">
                                <textarea class="form-control" style="height: 100px;" name="comentario" placeholder="Kommentar..."></textarea>
