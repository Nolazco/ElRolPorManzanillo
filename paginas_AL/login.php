...
<body class="container" style="background-color: #BEE3DF;">
    <center>
        <div class="formulario mt-2 mb-2" style="background: #F1EAC9">
            <div class="fs-1" style="text-align: left;"><a href="/index_AL.php"><i class="bi bi-house-door-fill"></i><i class="bi bi-arrow-left"></i></a></div>
            <div style="padding: 30px;">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                  ...
                  <center><input class="boton1" type="submit" value="Einloggen"></center>

                  <div class="form-text fs-6 fw-bold">Sie haben kein Konto? <a href="register.php">Klicke hier</a></div>
                </form>
            </div>
        </div>
    </center>
