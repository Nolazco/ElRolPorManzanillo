...
<body>
    ...
    <main>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h3 class="card-title text-center contenido-textos" style="color: #83C976; font-weight: bold;"><span class="circulo"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevrons-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    </svg></span> Que puedes encontrar en nuestro blog</h3>
                                <p class="card-text tam-texto" style="text-align: justify;">En este blog podrás encontrar opiniones acerca de los mejores restaurantes de Manzanillo, así como lugares turísticos a los que ir a divertirte con amigos y familia.</p>
                            </div>
                        </div>
                    </div>
                </div>              
        ...
        <section class="manzanilloo mb-4">
            ...
            <p class="tam-texto-man contenido-textos">Manzanillo es un activo puerto y un destino turístico, ubicada en la costa del océano Pacífico, contando con dos bahías; Manzanillo y Santiago.</p>
        ...
        <section class="opciones">
            <div class="contenedor">
                <h2 class="titulo"> Categorías </h2><br>
                <div class="galeria-opc">
                    <a href="/paginas/turismo.php" style="text-decoration: none; color: #000000;">
                    ...
                    <a href="/paginas/gastronomia.php" style="text-decoration: none; color: #000000;">
                    <div class="imagen-opc">
